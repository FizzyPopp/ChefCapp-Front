...
class Recipe {
  ...
  bool get isPartial {
    return _id != null && _title != null && _prepTime != null && _cookTime != null && _calories != null && _tags != null && _ingredients != null && _cookware != null && _steps != null && _thumb != null;
  }
  ...
  Recipe withSteps(List<RecipeStep> _newSteps) {
    return Recipe(_id, _title, _prepTime, _cookTime, _calories, _tags, _ingredients, _cookware, _newSteps, _thumb);
  }
